...
class MockMLService:
    ...
    def get_mock_risk_scores(self, age: int, gender: str, smoking_status: str, activity_level: str) -> Tuple[Dict[str, float], str]:
        ...
        scores = {
            ...
            "ИБС (Сердце)": round(max(0.0, min(1.0, base_ihd_risk + random.uniform(-0.05, 0.05))), 2),
        }
